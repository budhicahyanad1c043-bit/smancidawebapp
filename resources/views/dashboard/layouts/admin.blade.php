                    ...
                    <a href="{{ route('dashboard.index') }}" 
                       ...
                       title="Dashboard">
                        ...
                        @if(Request::is('dashboard') && !Request::is('dashboard/users*') && !Request::is('dashboard/settings*'))
                            <span class="absolute left-0 top-2 bottom-2 w-1 bg-amber-500 rounded-r-full" x-show="!sidebarCollapsed"></span>
                        @endif
                    ...
                    <div class="space-y-1">
                        ...
                        <a href="{{ route('posts.index') }}" 
                           ...
                           title="Artikel & Berita">
                            ...
                            @if(Request::is('dashboard/posts*'))
                                <span class="absolute left-0 top-2 bottom-2 w-1 bg-lime-100 rounded-r-full" x-show="!sidebarCollapsed"></span>
                            @endif
                        ...
                        <a href="{{ route('galleries.index') }}" 
                           ...
                           title="Galeri Foto">
                            ...
                            <!-- Indicator Garis Aktif -->
                            @if(Request::is('dashboard/galleries*'))
                                <span class="absolute left-0 top-2 bottom-2 w-1 bg-lime-100 rounded-r-full" x-show="!sidebarCollapsed"></span>
                            @endif
                        ...
                        <a href="{{ route('announcements.index') }}" 
                           ...
                           <!-- Indicator Garis Aktif -->
                            @if(Request::is('dashboard/announcements*'))
                                <span class="absolute left-0 top-2 bottom-2 w-1 bg-lime-100 rounded-r-full" x-show="!sidebarCollapsed"></span>
                            @endif
                    ...
                    <div class="space-y-1">
                        <a href="{{ route('extracurriculars.index') }}" 
                           ...
                           title="Ekstrakurikuler">
                            ...
                            <!-- Indicator Garis Aktif -->
                            @if(Request::is('dashboard/extracurriculars*'))
                                <span class="absolute left-0 top-2 bottom-2 w-1 bg-lime-100 rounded-r-full" x-show="!sidebarCollapsed"></span>
                            @endif
                    ...
                    <a href="{{ route('profile.edit') }}" 
                       ...
                       title="Profil Saya">
                        ...
                        @if(Request::is('dashboard/profile*'))
                            <span class="absolute left-0 top-2 bottom-2 w-1 bg-yellow-200 rounded-r-full" x-show="!sidebarCollapsed"></span>
                        @endif
