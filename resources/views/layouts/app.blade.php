...
<body class="bg-slate-50 text-slate-900 antialiased font-sans">
    ...
    <header class="bg-white border-b border-slate-100 py-4">
        <div class="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center gap-4">
            ...
            <img src="{{ asset('images/logo_smancida.png') }}" alt="Logo SMAN 1 Cidahu" class="h-20 w-auto object-contain">
            <div class="text-center sm:text-left">
                <h1 class="text-2xl font-bold tracking-tight text-blue-900">SMAN 1 CIDAHU</h1>
                <p class="text-xs uppercase tracking-wider text-slate-500 font-semibold mt-0.5">Religius, Unggul, Berwawasan Global</p>
    ...
    <footer id="tentang-kami" class="bg-slate-900 text-slate-300 pt-16 pb-8 border-t-4 border-blue-700">
        <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-12 mb-12">
            <div>
                <h4 class="text-white font-bold text-lg mb-4 border-l-4 border-blue-500 pl-3">SMAN 1 Cidahu</h4>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-slate-400">
                    <li class="flex items-start gap-2.5">
                        ...
                        <span>Jl. Pasirreungit RT.03 RW.08 Desa Jayabakti, Kecamatan Cidahu, Kabupaten Sukabumi 43358</span>
                    </li>
                    <li class="flex items-center gap-2.5">
                        <span class="text-blue-400">✉️</span>
                        <a href="mailto:smanegeri1cidahu@gmail.com" class="hover:underline hover:text-white">smanegeri1cidahu@gmail.com</a>
                    </li>
                    <li class="flex items-center gap-2.5">
                        <span class="text-blue-400">🌐</span>
                        <a href="https://smanegeri1cidahusmi.sch.id" target="_blank" class="hover:underline hover:text-white">smanegeri1cidahusmi.sch.id</a>
                    </li>
                </ul>
            </div>
            <div>
        ...
        <div class="max-w-7xl mx-auto px-6 pt-6 border-t border-slate-800 text-center text-xs text-slate-500">
            <p>&copy; {{ date('Y') }} SMAN 1 Cidahu. Hak Cipta Dilindungi.</p>
        </div>
    </footer>
